...
from .actions import Action, DeviceActions, Direction
...
class BondFan(BondEntity, FanEntity):
    ...
    def _speed_range(self) -> tuple[int, int]:
        ...
        return (
            1,
            len(DeviceActions.API_FAN_SPEEDS),
        )  # self._device.props.get("max_speed", 3))
    ...
    async def async_turn_on(
        ...
        **kwargs: Any,
        ...
        if preset_mode is not None:
            ...
            await self._hub.bond.action(self._device.device_id, Action.set_speed(1))
