...
# Nelsony Buttons types.
#
# Up, Stop, Down, Open, Close, Qtr, Half, Third
# Speed 1, Speed 2, Speed 3, Speed, 4
# Speed 5, Speed 6, Direction
# Light On, Light Off
# Tilt Up, Stop Tilt, Tilt Down
#


@dataclass
class BondButtonEntityDescriptionMixin:
    """Mixin to describe a Hub Button entity."""
...
class BondButtonEntityDescription(
    ...
    """Class to describe a Hub Button entity."""
...
BUTTONS: tuple[BondButtonEntityDescription, ...] = (
    BondButtonEntityDescription(
        key=Action.UP,
        name="Up",
        mutually_exclusive=None,  # Action.UP,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.DOWN,
        name="Down",
        mutually_exclusive=None,  # Action.DOWN,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.OPEN,
        name="Open",
        mutually_exclusive=None,  # Action.OPEN,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.CLOSE,
        name="Close",
        mutually_exclusive=None,  # Action.CLOSE,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.OPEN_QTR,
        name="Open one quarter",
        mutually_exclusive=None,  # Action.OPEN_QTR,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.OPEN_HALF,
        name="Open one half",
        mutually_exclusive=None,  # Action.OPEN_HALF,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.OPEN_THIRD,
        name="Open three quarter",
        mutually_exclusive=None,  # Action.OPEN_THIRD,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.TILT_UP,
        name="Tilt Up",
        mutually_exclusive=None,  # Action.TILT_UP,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.TILT_DOWN,
        name="Tilt Down",
        mutually_exclusive=None,  # Action.TILT_DOWN,
        argument=None,
    ),
    BondButtonEntityDescription(
        ...
        mutually_exclusive=None,  # Action.SET_DIRECTION,
        argument=None,
    ),
    BondButtonEntityDescription(
        key=Action.TURN_ON,
        ...
        mutually_exclusive=None,  # Action.TURN_ON,
        argument=None,
    ),
    # Bond buttons.
    BondButtonEntityDescription(
...
async def async_setup_entry(
    ...
    for device in hub.devices:
        device_entities = [
            BondButtonEntity(hub, device, description)  # bpup_subs, description)
        ...
        if device_entities and device.has_action(STOP_BUTTON.key):
            ...
            device_entities.append(
                BondButtonEntity(hub, device, STOP_BUTTON)  # bpup_subs, STOP_BUTTON)
            )
...
class BondButtonEntity(BondEntity, ButtonEntity):
    ...
    def __init__(
        ...
        super().__init__(hub, device, description.name, description.key.lower())
