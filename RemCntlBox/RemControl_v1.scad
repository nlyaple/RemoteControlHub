...
module lid()
{
    difference()
    {
        ...
        translate([(outside_width / 2) + 2.1, 90+thickness, -0.1])
        {
                cylinder(h=(thickness * 2) + 1.100, d=2.75, center=true, $fs=0.2);                
        }
        // column_offset+baseOffset+16+thickness
        translate([(outside_width / 2) + 2.1, 16+thickness, -0.1])
        {
                cylinder(h=(thickness * 2) + 1.100, d=2.75, center=true, $fs=0.2);                
        }
    ...
    // PC Board mounting 
    translate([(outside_width / 2) + 2.1, 90+thickness, 0])
    {
        difference()
        {
    ...
    // column_offset+baseOffset+16+thickness
    translate([(outside_width / 2) + 2.1, 16+thickness, 0])
    {
        difference()
        {
            cylinder(d=6, h=5, $fn=100);
